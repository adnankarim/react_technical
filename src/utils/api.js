...
const apiHost = "https://api.i69app.com/api";
...
export class Api {
  ...
  static getChatMessages(onPutFn, onPatchFn, onErrorFn) {
    const messages = new EventSource(
      "https://i69social.firebaseio.com/messages.json"
    );
    messages.onerror = (e) => {
      console.error(e);
      onErrorFn(e);
  ...
  static getChatUsersDetails(onDataFn, onErrorFn) {
    const users = new EventSource(
      "https://i69social.firebaseio.com/users.json"
    );
    users.onerror = (e) => {
      console.error(e);
      onErrorFn(e);
  ...
  static getFakeUsersDetails() {
    var request = new Request(
      "https://i69social.firebaseio.com/fakeUsers.json",
      {
        method: "GET",
      }
    );
