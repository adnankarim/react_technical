...
//         });
//         Api.getChatMessages(onSSEData(chatActionTypes.GET_CHAT_MESSAGES_UPDATE, dispatch), onSSEData(chatActionTypes.UPDATE_CHAT_HISTORY, dispatch), onSSEFailure(chatActionTypes.GET_CHAT_MESSAGES_LIST_FAILURE, dispatch));
//     }
// }
export function getMessages() {
    return function(dispatch) {
